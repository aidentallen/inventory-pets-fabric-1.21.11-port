...
extends MobRenderer<BillGatesEntity, BillGatesModel<BillGatesEntity>> {
    private static final Identifier CEO_SKIN = Identifier.parse((String)"inventorypets:textures/entity/bg.png");

    public BillGatesRenderer(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn, new BillGatesModel(renderManagerIn.bakeLayer(ModelLayers.VILLAGER)), 0.5f);
    ...
    public Identifier getTextureLocation(BillGatesEntity entity) {
        return CEO_SKIN;
    }
}
