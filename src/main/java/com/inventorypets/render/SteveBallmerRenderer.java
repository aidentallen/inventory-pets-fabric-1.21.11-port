...
import com.inventorypets.models.SteveBallmerModel;
...
public class SteveBallmerRenderer
extends MobRenderer<SteveBallmerEntity, SteveBallmerModel<SteveBallmerEntity>> {
    private static final Identifier CEO_SKIN = Identifier.fromNamespaceAndPath((String)"inventorypets", (String)"textures/entity/sb.png");

    public SteveBallmerRenderer(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn, new SteveBallmerModel(renderManagerIn.bakeLayer(ModelLayers.VILLAGER)), 0.5f);
    ...
    public Identifier getTextureLocation(SteveBallmerEntity entity) {
        return CEO_SKIN;
    }
}
