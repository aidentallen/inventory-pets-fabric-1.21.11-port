...
public class AnvilPetRenderer<Type extends AnvilPetEntity>
extends MobRenderer<Type, AnvilPetModel<Type>> {
    private static final Identifier PET_TEXTURES = Identifier.fromNamespaceAndPath((String)"inventorypets", (String)"textures/entity/anvil_pet_entity.png");

    public AnvilPetRenderer(EntityRendererProvider.Context context) {
        super(context, new AnvilPetModel(context.bakeLayer(AnvilPetModel.LAYER_LOCATION)), 0.5f);
    }

    protected void scale(AnvilPetEntity entity, PoseStack poseStackIn, float sizeIn) {
